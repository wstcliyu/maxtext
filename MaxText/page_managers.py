...
class PageState:
  ...
  page_status: Array # (num_pages, )
  page_map: Array # (slots, max_num_pages_per_slots)
  sequence_lengths: Array # (slots,)
  num_pages_used: Array # (slots,)
  current_page: Array # (slots,)
  current_page_position: Array # (num_pages,)
