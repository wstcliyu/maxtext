...
# Train
export LIBTPU_INIT_ARGS="--xla_tpu_enable_data_parallel_all_reduce_opt=true --xla_tpu_data_parallel_opt_different_sized_ops=true --xla_tpu_enable_async_collective_fusion=true --xla_tpu_enable_async_collective_fusion_fuse_all_gather=true --xla_tpu_enable_async_collective_fusion_multiple_steps=true --xla_tpu_overlap_compute_collective_tc=true --xla_enable_async_all_gather=true --xla_tpu_scoped_vmem_limit_kib=98307"

python MaxText/$EXECUTABLE MaxText/configs/base.yml model_name=gemma2-9b\
  base_output_directory=$OUTPUT_PATH dataset_path=${DATASET_PATH}\
  tokenizer_path=assets/tokenizer.gemma per_device_batch_size=2 remat_policy=full\
  steps=15 enable_checkpointing=false use_iota_embed=true ici_fsdp_transpose_parallelism=256